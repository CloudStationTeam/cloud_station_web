...
function addTab(droneID) {
    ...
    $('#tab-content').append($('<div class="tab" id = "content' + droneID.toString() + '">' +
        ...
        '<tr><td>' + '<var id = ' + longitudeID + '></var>' + '</td><td>' + '<var id = ' + latitudeID + '></var>' + '</td></tr>' +
        '<tr><th>Type</th><th>Flight Mode</th></tr>' +
        '<tr><td>' + '<var id = ' + typeID + '></var>' + '</td><td>' + '<var id = ' + flyModeID + '></var>' + '</td></tr>' +
        '<tr><th>Fix Type</th><th>Satellites Visible</th></tr>' +
        '<tr><td>' + '<var id = ' + fixTypeID + '></var>' + '</td><td>' + '<var id = ' + satellitesID + '></var>' + '</td></tr>' +
        '<tr><th>VCC</th><th>VSERVO</th></tr>' +
        '<tr><td>' + '<var id = ' + vccID + '></var>' + '</td><td>' + '<var id = ' + vservoID + '></var>' + '</td></tr>' +
        '</table>'));
