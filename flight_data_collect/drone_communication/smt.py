...
def main1(url): #done.
  ...
  #TODO: map pins.
  mission waypoints.append(mission item(0, 0, 42.434193622721835, -83.98098183753619, 10)) # Above takeoff point

  mission waypoints.append(mission item(1, 0, 42.43432724637685, -83.98613425948624, 10)) # Above Destination Point

  mission waypoints.append(mission item(2, 0, 42.43432724637685, -83.98613425948624, 5)) # Destination Point
